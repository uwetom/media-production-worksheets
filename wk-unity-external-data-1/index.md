...
The NASA json data contains all this information.  Each ```near_earth_object```(asteroid) has a name and  size. [Preview](https://raw.githubusercontent.com/uwetom/media-production-worksheets/master/wk-intro-external-data/images/neows-4.png)   Each asteroid is also classified as ```"is_potentially_hazardous_asteroid": false,``` or ```true```. 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMTYxNzIyNjQsOTcxMDY0NzYyLDE1Nj
