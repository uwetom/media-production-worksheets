...
![download a GitHub repo as zip file](https://uwetom.github.io/media-production-worksheets/wk-using-external-data/images/download-repo.png)
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTkzMzk2NjE4XX0=
-->