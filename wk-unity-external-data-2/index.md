...
It is possible to use incoming data to alter nearly every aspect of your your scene by using the data to change, add and remove  Game Objects (objects, atmosphere, materials, texture, physics and so on). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU2NTg4OTUwNCwtNDUxMTUxODc4LDg4Nj
