...
So we need how to let the scr over to the light and add some scripting to the light to turn it on and off. So that's what we're going to do next.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MTg0OTMwOCwxMzUyOTk1NTY2LC04ND
