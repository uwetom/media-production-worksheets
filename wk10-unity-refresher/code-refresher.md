...
Hint: you will need to refactor (rewrite) bits of your code. There are a few ways to do this but probably the easies so that the light script checks the collision script for collisions on every frame
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUwODE2ODQxMCwxMDUxMjc4ODM4LDEzNT
