...
And specifically for the collision detection script to run the `ChangeLight()` function in the light script...  So that's what we're going to do next.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIzNDAzMDY3NywxMzUyOTk1NTY2LC04ND
