...
This example of data about Near Earth Objects (NEO / asteroids that will pass close to earth) https://api.nasa.gov/ needs a log in and API Key. The format for the HTTP web request is:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYzNTU5MDEyNSwtMTUzMTkzOTAyMCwtNT
