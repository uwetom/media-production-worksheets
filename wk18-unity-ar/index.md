...
![turn on XR Simulation](https://github.com/uwetom/media-production-worksheets/blob/master/wk18-unity-ar/images/interaction_toolkit.jpg?raw=true)
...
![toolkit samples](https://github.com/uwetom/media-production-worksheets/blob/master/wk18-unity-ar/images/toolkit_samples.jpg?raw=true)
...
![toolkit samples](https://github.com/uwetom/media-production-worksheets/blob/master/wk18-unity-ar/images/ship_collider.jpg?raw=true)
...
2. when the action is triggered send out a ray from where the user touches and check if it hits an object
...
Add an input Action Manager component XR origin
	add an action asset
	add default input actions ( uses new input system)
	
Add raycast manager

make a new object next to the main camera and call it "interactor"
	add an xr ray interactor - tick enable ar raycasting
	add a screen space controller
		add tap start and drag current touch gestures
...
![toolkit samples](https://github.com/uwetom/media-production-worksheets/blob/master/wk18-unity-ar/images/interaction_manger.jpg?raw=true)
...
----------connect the interactor to the script video --------------------

- Go into the simple interactable component and go into interactable events
- Press plus on the Select Entered section
- drag the main controller onto it
- choose the interaction.selected function
...
- create new empty game object in ship and call it annotation
- add a text mesh-pro - text component ( install tmp)
- add any other things you want 
